{{-- START NEW COUNTRY --}}
<div class="modal fade" id="editEmpInfoModal">
  <div class="modal-dialog" style="width:80%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="frmEditEmpMission" method="post" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              <button id="btnEditEmpMissionPost" post-url="{{url("update/employee")}}" type="submit" class="btn btn-success">Засах</button>
            </div>
          </div>
        </form>
      </div>
