{{-- START NEW COUNTRY --}}
<div class="modal fade" id="newPunishment">
  <div class="modal-dialog" style="width:80%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmNewCountry" action="{{ action('punishmentController@store')}}" method="post" data-parsley-validate class="form-horizontal form-label-left">
          @csrf
          <div id="frmNewPunishment" method="post" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-3">
                  <select class="form-control" name="cmbNewPunishmentCountry" id="cmbNewPunishmentCountry">
              ...
              <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-3">
                  <select class="form-control" name="cmbNewPunishmentEelj" id="cmbNewPunishmentEelj">
                    <option value="-1">Сонгоно уу</option>
                  </select>
              </div>
          ...
          <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-5">
              ...
              <textarea id="memoPunishment" class="form-control" name="memoPunishment"></textarea>
          </div>
          <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-5">
          ...
          <div class="clearfix"></div>
          <button type="button" class="btn btn-success" id="btnPostNewPunishment">Хадгалах</button>
      </div>
    </form>
<div class="clearfix"></div>
